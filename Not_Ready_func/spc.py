...
RULES_BASIC = [RULES_1_BEYOND_3SIGMA,   RULES_7_ON_ONE_SIDE]
...
class Spc(object):
    ...
    **Usage**
    ...
    def __init__(self, data, chart_type, rules=RULES_BASIC, newdata=[], sizes=None):
        ...
        sfsf, pdpd = STATS_FUNCS[chart_type]
        if sizes == None:
            ...
            size = sizes
        self.center, self.lcl, self.ucl = sfsf(data, size)
        self._data = pdpd(data, size)
